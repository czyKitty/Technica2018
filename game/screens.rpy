...
screen char_choice():
    imagemap:
        ground "images/char_choice0.png"
        hotspot (91, 34, 230, 613) action [Hide("char_choice1"),Return("suril.png")] hovered Show("char_choice1") unhovered Hide("char_choice1")
        hotspot (342, 125, 101, 442) action [Hide("char_choice2"),Return("savia.png")] hovered Show("char_choice2") unhovered Hide("char_choice2")

screen char_choice1():
    imagemap:
        ground "images/char_choice1.png"

screen char_choice2():
    imagemap:
        ground "images/char_choice2.png"
...
screen schedule(money,happiness,effort,salary,social_good,time):
    ...
    default v_e = 0
    default v_m = 0
    default entertain_t = 0
    default entertain_h = 0
    default entertain_e = 0
    default entertain_m = 0
    default travel_t = 0
    default travel_h = 0
    default travel_e = 0
    default travel_m = 0
    ...
    #add "schedule.png"
        ...
        text str(work_e) xpos 890 ypos 237
        text str(work_m) xpos 1100 ypos 237
        
        text str(v_t) xpos 362 ypos 317
        text str(v_h) xpos 680 ypos 317
        text str(v_e) xpos 890 ypos 317
        text str(v_m) xpos 1100 ypos 317
        
        text str(entertain_t) xpos 362 ypos 400
        text str(entertain_h) xpos 680 ypos 400
        text str(entertain_e) xpos 890 ypos 400
        text str(entertain_m) xpos 1100 ypos 400
        
        text str(travel_t) xpos 362 ypos 475
        text str(travel_h) xpos 680 ypos 475
        text str(travel_e) xpos 890 ypos 475
        text str(travel_m) xpos 1100 ypos 475
        
        text str(net_t) xpos 362 ypos 560
        text str(net_h) xpos 680 ypos 560
        text str(net_e) xpos 890 ypos 560
        text str(net_m) xpos 1100 ypos 560

        if cur_money < 0:
            text "{b}{color=#ff0000}{size=+20}You cannot afford that!{/size}{/color}{/b}" xpos 450 ypos 400
        if cur_happiness < 0:
...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("Quit") action Rollback()
